                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-12">
                                    <input type="file" id="subtitle" name="subtitle" multiple size="10" @change="SHOW_FILES_INFO('subtitle','subtitleFileDetails')" class="inputfile">
                            ...
                            <tr v-for="(item, index) in data_search.movies" :key="index">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button class="btn btn-sm btn-warning btn-sm mr-2" @click="ADD_TO_TOP(item.id,index)" v-if="item.movie_id !== item.id" :id="item.id">
                                            Top
                                        </button>
                                        ...
                                        <router-link class="btn btn-sm btn-warning btn-sm mr-2" :to="{name:'movie_edit', params: {id:item.id}}" role="button">Edit
                                        </router-link>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr v-for="(item, index) in data.movies.data" :key="index">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button class="btn btn-sm btn-warning btn-sm mr-2" @click="ADD_TO_TOP(item.id,index)" v-if="item.movie_id !== item.id" :id="item.id">Top
                                        </button>
                                        <button class="btn btn-sm btn-warning btn-sm mr-2" @click="GET_SUBTITLE(item.id,index)" data-toggle="modal" data-target="#GetSubtitleModal">Get Subtitles
                                        </button>
                                        <router-link class="btn btn-sm btn-warning btn-sm mr-2" :to="{name:'movie_edit', params: {id:item.id}}" role="button">Edit
